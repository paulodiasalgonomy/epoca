(function () {
  const IMAGES = [
    { src: "https://images.unsplash.com/photo-1500530855697-b586d89ba3ee", alt: "Foto 1" },
    { src: "https://images.unsplash.com/photo-1495567720989-cebdbdd97913", alt: "Foto 2" },
    { src: "https://images.unsplash.com/photo-1503264116251-35a269479413", alt: "Foto 3" },
    { src: "https://images.unsplash.com/photo-1519681393784-d120267933ba", alt: "Foto 4" }
  ];
  ...
  IMAGES.forEach((img, idx) => {
    ...
    item.className = "item";
    item.innerHTML = `<span class="ring"></span><img src="${img.src}" alt="${img.alt || ""}">`;
  ...
  function nextStory() {
    document.querySelectorAll('#insta-stories-carousel .ring')[currentIndex]
